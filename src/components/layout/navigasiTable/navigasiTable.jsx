  ...
  return (
    <>
      <div className="w-full pt-40">
        <div className="lg:w-[60vw] w-[85vw] mx-auto py-1 rounded-md shadow-lg text-xl font-poppins tracking-wide font-semibold gradiasi-hijau flex items-center justify-center gap-1 px-4">
          <Link
            to={linkSatu}
